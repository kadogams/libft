...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/03/06 11:47:15 by skadogam          #+#    #+#             */
/*   Updated: 2019/03/06 17:43:03 by skadogam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** soustrait les 2 premiers registres, et met le résultat dans le 3eme
*/
...
int		op_sub(t_vm *vm, t_pc *pc, int arg[3], char arg_type[3])
{
	...
	{
		if (vm->opt_v & 4)
			verbosity_4(*pc, g_op[5], pc->arg, pc->arg_type);
		if (vm->opt_v & 16)
